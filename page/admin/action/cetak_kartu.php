...
<body>
    <div class="card">
        <div class="card-header">
            <img src="../assets/default_logo_sekolah_pintar.png" alt="Logo Sekolah">
            <div class="school-info">
                <h2>SMA Negeri 2 Campalagian</h2>
                <p>Katumbangan, Kabupaten Polewali Mandar, Sulawesi Barat</p>
            </div>
        </div>
        <img class="student-photo" id="foto-siswa" src="../foto_siswa/<?php echo $row['FotoSiswa']; ?>" alt="Foto Siswa">
