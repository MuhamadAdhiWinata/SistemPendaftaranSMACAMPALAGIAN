...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jun 2024 pada 18.29
...
--
ALTER TABLE `petugasppdb`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=215610051;
...
--
ALTER TABLE `siswa`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=215610060;
...
--
-- Ketidakleluasaan untuk tabel `kartupelajar`
--
ALTER TABLE `kartupelajar`
  ADD CONSTRAINT `kartupelajar_ibfk_1` FOREIGN KEY (`PendaftaranID`) REFERENCES `pendaftaran` (`ID`);

--
-- Ketidakleluasaan untuk tabel `seleksi`
--
ALTER TABLE `seleksi`
  ADD CONSTRAINT `seleksi_ibfk_1` FOREIGN KEY (`PendaftaranID`) REFERENCES `pendaftaran` (`ID`);
COMMIT;
